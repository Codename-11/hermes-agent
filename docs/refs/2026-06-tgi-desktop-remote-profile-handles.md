# TGI Desktop remote profile handles

Status: TGI fork patch, temporary until upstream lands equivalent peer-gateway/profile switching.
...
- <https://github.com/NousResearch/hermes-agent/pull/39778> — merged per-profile remote gateway hosts. This TGI patch builds on that landed behavior.
...
2. Remove the TGI IPC methods, renderer panel, strings, and this docs entry.
