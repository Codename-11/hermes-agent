...
class PluginManager:
    ...
    def _discover_and_load_inner(self) -> None:
        ...
        for manifest in winners.values():
            ...
            # Compute opt-in before the bundled-platform path. A platform
            # plugin may also expose tools; explicitly enabled platforms must
            # load eagerly so those tools register and appear in `hermes tools`.
            ...
            # Explicitly enabled platform plugins load eagerly so their tools
            # and hooks are available to agent sessions.
