...
class PluginContext:
    ...
    def register_command(
        ...
        *, subcommands: tuple[str, ...] | None = None, category: str = "Plugin",
        gateway_only: bool = False, cli_only: bool = False,
        aliases: tuple[str, ...] = (), returns_card: bool = False,
    ) -> Optional[PluginRegistration]:
        ...
        entry = {
            ...
            "subcommands": tuple(subcommands) if subcommands else (), "category": category,
            "gateway_only": bool(gateway_only), "cli_only": bool(cli_only),
            "aliases": tuple(
