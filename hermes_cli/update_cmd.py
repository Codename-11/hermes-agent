...
def _print_update_brief(
    ...
    *,
    ...
    try:
        ...
        from hermes_cli.update_ui import write_brief_prompt_inject, write_update_brief
        ...
        if gateway_mode:
            ...
            if inject_path is not None:
                print("  ✓ Hermes will post a natural-language summary in this channel shortly.")
    except Exception as exc:
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        if deploy_commit_count:
            # The deploy reconciler already fast-forwarded this checkout to its
            # tested artifact. Keep the normal post-update pipeline active even
            # though HEAD now equals origin/<deploy>.
            commit_count = max(1, deploy_commit_count)
        ...
        if pre_pull_sha and post_pull_sha == pre_pull_sha and not is_deploy_branch:
            print()
