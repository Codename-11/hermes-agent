...
def _do_build_web_ui(web_dir: Path, *, fatal: bool = False) -> bool:
    ...
    # The web build needs devDependencies (typescript/tsc, vite). Force
    # them into the install even when a deployed gateway exports
    # NODE_ENV=production; keep the build command environment unchanged.
