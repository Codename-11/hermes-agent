...
def _isolate_slack_env():
    ...
    yield
    # load_gateway_config() writes bridge variables directly to os.environ, not
    # through pytest's monkeypatch fixture.  Clean with os.environ.pop so those
    # direct writes cannot be restored into the following module by monkeypatch
    # teardown ordering.
    for name in names:
        os.environ.pop(name, None)
