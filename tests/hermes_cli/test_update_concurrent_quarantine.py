"""Tests for issue #26670 — concurrent hermes.exe detection and fail-closed
quarantine retry behavior during `hermes update` on Windows.
...
# ---------------------------------------------------------------------------
# _quarantine_running_hermes_exe — retry + fail-closed abort
# ---------------------------------------------------------------------------
