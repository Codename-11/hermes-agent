...
/**
 * Default transport — spawns `python -m tui_gateway.entry` as a child process
 * and pipes line-delimited JSON-RPC over stdio. Extracted verbatim from the
 * pre-Phase-2 GatewayClient so local mode behavior is identical.
 */
export class LocalSubprocessTransport extends EventEmitter implements Transport {
