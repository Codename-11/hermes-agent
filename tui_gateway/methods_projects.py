...
def _project_tree_inputs(
    ...
    rows = db.list_sessions_rich(
        sources=list(PROJECT_CONVERSATION_SOURCES), limit=-1, offset=0,
        order_by_last_active=True, min_message_count=1, include_children=False,
...
def _build_project_tree(
    ...
    tree = project_tree.build_tree(
        ...
        hydrate=hydrate, active_session_id=active_session_id,
