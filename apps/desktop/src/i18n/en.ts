...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteProfileDefaultTitle: 'Default profile is global',
      remoteProfileDefaultDesc:
        'The remote default profile uses the All profiles connection. Create or choose a named remote profile if you want a separate rail handle.',
      pinRemoteProfileNew: 'Add handle',
      pinRemoteProfileExisting: 'Pin remote',
      remoteProfilePinnedTitle: 'Remote profile pinned',
      remoteProfilePinned: name => `${name} now points at this remote gateway. Select it from the profile rail to switch agents.`,
