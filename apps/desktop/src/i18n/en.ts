...
export const en: Translations = {
  ...
  keybinds: {
    ...
    actions: {
      ...
      'composer.autoSpeak': 'Toggle read replies aloud',
      'composer.wakeWord': 'Toggle Hey Hermes wake word',
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteProfilesTitle: 'Remote profiles',
      remoteProfilesDesc:
        'Load profiles from this remote gateway, then add them as local profile handles. Each handle is pinned to the remote gateway so the profile rail can hot-swap between local and remote agents.',
      loadRemoteProfiles: 'Load remote profiles',
      remoteProfilesFrom: baseUrl => `Profiles from ${baseUrl}`,
      remoteProfilesEmpty: 'This gateway did not report any profiles.',
      remoteProfilesLoadedTitle: 'Remote profiles loaded',
      remoteProfilesLoaded: (count, baseUrl) => `${count} ${count === 1 ? 'profile' : 'profiles'} loaded from ${baseUrl}`,
      remoteProfilesFailed: 'Remote profiles failed to load',
      remoteProfileDefault: 'default',
      remoteProfileRemote: 'remote',
      remoteProfileNoModel: 'No model configured',
      remoteProfileLocal: 'Local handle exists',
      remoteProfileHandleLabel: 'Local handle',
      remoteProfileHandleHint: remoteProfile => `Routes to remote profile “${remoteProfile}”. Use a unique local name.`,
      remoteProfileHandleInvalidTitle: 'Choose a local handle',
      remoteProfileHandleInvalidDesc:
        'Use a unique profile handle like server-atlas or tgi-atlas. The handle cannot be default.',
      pinRemoteProfileNew: 'Add handle',
      pinRemoteProfileExisting: 'Update pin',
      remoteProfilePinnedTitle: 'Remote profile pinned',
      remoteProfilePinned: (remoteProfile, localHandle) =>
        `Remote “${remoteProfile}” is pinned as local handle “${localHandle}”. Select it from the profile rail to switch agents.`,
      remoteProfilePinFailed: name => `Could not pin ${name}`,
  ...
  profiles: {
    ...
    visibilityDesc: 'Choose which named profiles appear in the profile rail and its keyboard navigation.',
    showProfileInUi: name => `Show ${name}`,
    showProfileInUiDesc: 'Hidden profiles and their chats are preserved and remain available through search and direct links.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      newWorktreeSession: 'New worktree session…',
      lifecycleMenu: project => `${project} session actions`,
      moveCurrentSessionToWorktree: 'Move current session to new worktree',
      ...
      worktreeRepositoryLabel: 'Repository',
      worktreeIntentLabel: 'Worktree intent',
      createWorktreeIntent: 'Create new branch',
      openExistingIntent: 'Open existing branch',
      ...
      viewAllSessions: count => `View all ${count} sessions`,
      back: 'All projects'
    },
