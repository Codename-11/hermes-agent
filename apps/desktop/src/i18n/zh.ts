...
export const zh: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteProfilesFailed: '远程 profiles 加载失败',
      remoteProfileDefault: 'default',
      remoteProfileNoModel: '未配置模型',
      remoteProfileLocal: '本地入口已存在',
      remoteProfileDefaultTitle: 'Default profile 是全局连接',
      remoteProfileDefaultDesc:
        '远程 default profile 使用“所有 profiles”连接。如果需要单独的栏位入口，请创建或选择一个命名的远程 profile。',
      pinRemoteProfileNew: '添加入口',
      pinRemoteProfileExisting: '固定远程',
      remoteProfilePinnedTitle: '远程 profile 已固定',
      remoteProfilePinned: name => `${name} 现在指向此远程网关。请从 profile 栏选择它来切换 agent。`,
      remoteProfilePinFailed: name => `无法固定 ${name}`,
