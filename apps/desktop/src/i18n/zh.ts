...
export const zh: Translations = {
  ...
  keybinds: {
    ...
    actions: {
      ...
      'composer.autoSpeak': '切换朗读回复',
      'composer.wakeWord': '切换 Hey Hermes 唤醒词',
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteProfilesTitle: '远程 profiles',
      remoteProfilesDesc:
        '从此远程网关加载 profiles，然后将它们添加为本地 profile 入口。每个入口都会固定到该远程网关，因此可通过 profile 栏在本地和远程 agents 之间热切换。',
      loadRemoteProfiles: '加载远程 profiles',
      remoteProfilesFrom: baseUrl => `来自 ${baseUrl} 的 profiles`,
      remoteProfilesEmpty: '此网关未报告任何 profiles。',
      remoteProfilesLoadedTitle: '远程 profiles 已加载',
      remoteProfilesLoaded: (count, baseUrl) => `已从 ${baseUrl} 加载 ${count} 个 profile`,
  ...
  profiles: {
    ...
    newProfile: '新建配置档案',
    newChat: '新建聊天',
    visibilityTitle: '配置档案可见性',
    visibilityDesc: '选择哪些命名配置档案显示在配置档案栏及其键盘导航中。',
    showProfileInUi: name => `显示 ${name}`,
    showProfileInUiDesc: '隐藏的配置档案及其聊天会保留，并可通过搜索和直接链接访问。',
  ...
  sidebar: {
    ...
    projects: {
      ...
      newWorktreeSession: '新建工作树会话…',
      lifecycleMenu: project => `${project} 会话操作`,
      moveCurrentSessionToWorktree: '将当前会话移至新工作树',
      ...
      worktreeRepositoryLabel: '仓库',
      worktreeIntentLabel: '工作树操作',
      createWorktreeIntent: '创建新分支',
      openExistingIntent: '打开现有分支',
      ...
      toggle: (label, open) => `${open ? '显示' : '隐藏'} ${label} 会话`,
      viewAllSessions: count => `查看全部 ${count} 个会话`,
      back: '所有项目'
    },
