...
export const ar = defineLocale({
  ...
  keybinds: {
    ...
    actions: {
      ...
      'composer.autoSpeak': 'تبديل قراءة الردود بصوت عالٍ',
      'composer.wakeWord': 'تبديل كلمة التنبيه Hey Hermes',
  ...
  sidebar: {
    ...
    projects: {
      ...
      newSessionInProject: 'جلسة جديدة في المشروع',
      newWorktreeSession: 'جلسة شجرة عمل جديدة…',
      lifecycleMenu: project => `إجراءات جلسات ${project}`,
      moveCurrentSessionToWorktree: 'نقل الجلسة الحالية إلى شجرة عمل جديدة',
      ...
      worktreeRepositoryLabel: 'المستودع',
      worktreeIntentLabel: 'غرض شجرة العمل',
      createWorktreeIntent: 'إنشاء فرع جديد',
      openExistingIntent: 'فتح فرع موجود',
      ...
      viewAllSessions: count => `عرض كل الجلسات (${count})`,
      back: 'كل المشاريع'
    },
