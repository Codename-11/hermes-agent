...
export const ja = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      startWork: '新しいワークツリー',
      newSessionInProject: 'プロジェクトで新しいセッション',
      newWorktreeSession: '新しいワークツリーセッション…',
      lifecycleMenu: project => `${project} のセッション操作`,
      moveCurrentSessionToWorktree: '現在のセッションを新しいワークツリーへ移動',
      ...
      worktreeRepositoryLabel: 'リポジトリ',
      worktreeIntentLabel: 'ワークツリーの操作',
      createWorktreeIntent: '新しいブランチを作成',
      openExistingIntent: '既存のブランチを開く',
