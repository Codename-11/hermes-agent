...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteProfilesTitle: '遠端 profiles',
      remoteProfilesDesc:
        '從此遠端閘道載入 profiles，然後將它們新增為本機 profile 入口。每個入口都會固定到該遠端閘道，因此可透過 profile 欄在本機和遠端 agents 之間熱切換。',
      loadRemoteProfiles: '載入遠端 profiles',
      remoteProfilesFrom: baseUrl => `來自 ${baseUrl} 的 profiles`,
      remoteProfilesEmpty: '此閘道未回報任何 profiles。',
      remoteProfilesLoadedTitle: '遠端 profiles 已載入',
      remoteProfilesLoaded: (count, baseUrl) => `已從 ${baseUrl} 載入 ${count} 個 profile`,
  ...
  sidebar: {
    ...
    projects: {
      ...
      startWork: '新增工作樹',
      newSessionInProject: '在專案中新增工作階段',
      newWorktreeSession: '新增工作樹工作階段…',
      lifecycleMenu: project => `${project} 工作階段操作`,
      moveCurrentSessionToWorktree: '將目前工作階段移至新工作樹',
      ...
      worktreeRepositoryLabel: '儲存庫',
      worktreeIntentLabel: '工作樹操作',
      createWorktreeIntent: '建立新分支',
      openExistingIntent: '開啟現有分支',
